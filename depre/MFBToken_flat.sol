...
// File: contracts/AddressCenter.sol
...
contract AddressCenter is Ownable{
    ...
    function initialize_1(address box, address gd, address gdp, address mfb_t, address mfb_p, address nft_t, address nft_m, address pancake_adr, address game_adr) 
    public 
    onlyOwner
    {
        blindbox = box;
